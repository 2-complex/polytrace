...
(function()
{
    ...
    var PolyTrace = function(containerDiv)
    {
    ...
    PolyTrace.prototype = dgn.inherit([App]);

    PolyTrace.launch = function(loader, containerDiv, receiveApp)
    {
        loader.loadAll([
            "js/math.js",
            ...
            function()
            {
                var app = new PolyTrace(containerDiv);
                receiveApp(app);
            }
        );
    }

    PolyTrace.prototype.init = function()
    {
        ...
        undoManager.setDrawScreen( function() { drawScreen(); } );
